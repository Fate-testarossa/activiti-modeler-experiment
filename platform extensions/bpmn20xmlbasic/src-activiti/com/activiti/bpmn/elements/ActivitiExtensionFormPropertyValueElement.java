...
@XmlRootElement(name="value",namespace="http://activiti.org/bpmn")
@XmlAccessorType(XmlAccessType.FIELD)
public class ActivitiExtensionFormPropertyValueElement extends AbstractExtensionElement{
     ...
     * Constructors 
     */
    public ActivitiExtensionFormPropertyValueElement() {
        super();
    }
